...
import { adderMessageinFirebase,deleteMessages } from "../../store/messages/actions";
// import {getChatMessagesListRefById} from '../../services/firebase'
...
const Chat = () => { 
 ...
 const addMessage = useCallback((newMessage) => {
     if (newMessage.message.trim()) {
      ...
      dispatch(adderMessageinFirebase(chatId,newMessage))     
     }
